    ...
    return (
        <div className="w-full text-center mt-12 mb-4">
            <div className="w-full flex flex-wrap items-center justify-center my-6 gap-8 sm:gap-12"> {/* I wrote this line of code with furry paws on. Just thought I would mention that. */}
                ...
                <a href="https://www.zeffy.com/en-US/donation-form/d8c52307-b470-4c2b-889e-bbdcc8ed71f6" target="_blank" className="w-12 h-12 scale-100 hover:scale-110 transition-transform duration-300">
